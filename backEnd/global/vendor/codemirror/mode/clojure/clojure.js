...
CodeMirror.defineMode("clojure", function (options) {
    ...
    var builtins = makeKeywords(
        "* *' *1 *2 *3 *client* *allow-unresolved-vars* *assert* *clojure-version* *command-line-args* *compile-files* " +
        ...
        "aclone add-classpath add-watch client client-error client-errors aget alength alias all-ns alter alter-meta! " +
        ...
        "chunk-buffer chunk-cons chunk-first chunk-next chunk-rest chunked-seq? class class? clear-client-errors " +
        ...
        "restart-client resultset-seq reverse reversible? rseq rsubseq satisfies? second select-keys send send-off seq seq? " +
        ...
        "*default-data-reader-fn* as-> cond-> cond->> reduced reduced? send-via set-client-send-executor! " +
        "set-client-send-off-executor! some-> some->>");
